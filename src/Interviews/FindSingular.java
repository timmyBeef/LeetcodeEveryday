...
class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(Solution.findSingular3(test1) == 5);


        String test2 = "1,2,5,6";

        System.out.println(Solution.findSingular3(test2) == 1);


        String test3 = "";

        try {
            Solution.findSingular(test3);
